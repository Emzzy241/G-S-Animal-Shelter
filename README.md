# Animal Shelter 2.0.0
#### made by Mojiboye Emmanuel

#### Implementing the Animal Shelter with database
...
## Description
_This is ann animal shelter application to keeps track of animals in their facility based on animal type(cat, dog, bunny)._
